...
diff_stats = get_stats("statistics/diff_fft_statistics_log_YCrCb.csv")
rain_stats = get_stats("statistics/rain_fft_statistics_log_YCrCb.csv")
...
for i, rain_image_path in enumerate(rain_image_paths):
    ...
    _, gt_phase, gt_mag_unnorm = generate_fft_YCRCB(groundtruth_filepath, 128)
    _, rain_phase, rain_mag_unnorm = generate_fft_YCRCB(rain_filepath, 128)
...
plt.tight_layout()
plt.savefig("all_data_dist_norm_YCrCb.png")